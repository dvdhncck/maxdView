...
*/
	...
	public void drawProfiles(Graphics graphic, int width, int height)
	{
		...
		if((n_cols > 0) && (n_rows > 0))
		{
		    ...
		    String str = mview.niceDouble(edata.getMinEValue(), 9, 4);
		    ...
		    double max = edata.getMinEValue();
		    double min = edata.getMaxEValue();
