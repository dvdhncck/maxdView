...
*/
	...
	my_parser.setKeywordSymbols( new String[] { "at", "most", "least", "any", "some", "none" } );
	my_parser.setFunctionSymbols( new String[] { "of", "min", "max", "sin", "cos", "tan" } );

	try
	{
	    TermNode root = my_parser.parse( str );
	    
	    System.out.print( root.getTypeAsString() );
    ...
    //
    //
    //    TermNode           :=   Identifier  |  Function  |  UnaryTermNode  |  BinaryTermNode | Keyword
    //
...
*/
    ...
    private boolean identifyVariableTermNodes( Vector things )
    {
	while( removeRedundantBrackets( things ) );
